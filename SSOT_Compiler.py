...
def generate_full_coverage_cases() -> List[TestCase]:
    ...
    # --- V46.45 / V46.46 Uber Payments 事件端點誤封修正 ---
    cases.append(TestCase("BugFix: Uber Payments _events Pass", "https://payments.uber.com/_events", RES_ALLOW, "V46.45 payments.uber.com /_events 加入 PATH_EXEMPTIONS；修正被泛用 /_events L1 規則誤封"))
    cases.append(TestCase("BugFix: Uber Payments events Pass", "https://payments.uber.com/events?key=production_qaq1kwevjhkwbpec", RES_ALLOW, "V46.46 payments.uber.com /events 加入 PATH_EXEMPTIONS；修正被泛用 /events L1 規則誤封"))

...
-------------------------
當前版本：V45.90 (2026-04-27)
最新架構更新：
- [AdBlock] Klook appapi.klook.com 廣告端點封鎖：DROP:/v1/adsrv/ + DROP:/v1/usrcsrv/splash/ads；liveactivity token 功能性放行。

近期更新摘要 (完整歷史軌跡請參閱 CHANGELOG.md)：
- V45.90 (2026-04-27): Klook adsrv 廣告版位 DROP + splash/ads 開屏廣告 DROP；liveactivity token 功能性放行。
- V45.89 (2026-04-27): help.uber.com /_track 頁面追蹤 DROP；csp.uber.com 判定 CSP 回報端點不封鎖。
- V45.88 (2026-04-27): tracking.ibt.uber.com IBT 行為遙測封鎖。
- V45.87 (2026-04-27): anonymous-communication.ghostery.net Human Web 數據貢獻端點封鎖。
- V45.86 (2026-04-27): apm.volccdn.com APM 遙測 + gator.volces.com 火山引擎數據聚合閘道封鎖。
"""

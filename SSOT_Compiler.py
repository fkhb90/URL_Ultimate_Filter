...
-------------------------
當前版本：V46.37 (2026-06-15)
最新架構更新：
- [Privacy] `x.com/i/api/1.1/promoted_content/log.json` 新增 `CRITICAL_PATH_MAP` 精準封鎖，阻擋推廣內容回報端點。
...
RULES_DB = {
    ...
    "CRITICAL_PATH_MAP": {
        ...
        'x.com': ['RE:^/i/api/1\\.1/promoted_content/log\\.json(?:\\?|$)'],

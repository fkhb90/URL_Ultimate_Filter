// ==UserScript==
// @name         URL Ultimate Filter V46.44
// @namespace    http://tampermonkey.net/
// @version      46.44
// @date         2026-06-19
// @description  SSOT 前端防護盾牌 V46.44 (2026-06-19) | 1533 rules — 極簡盾牌 UI，獨立計數器，點擊外部自動收合。
...
const RULES = {
  ...
  KEYWORDS: {
    ...
    'programmatic', 'pushnotification', 'quantserve', 'quantumgraph', 'queryly', 'rayjump',
    ...
    'mp/collect', '/report/', '/reporting/', '/reports/', '/unstable/produce_batch', '/v1/produce',
    '/bugsnag/', '/crash/', 'debug/mp/collect', '/error/', '/envelope', '/exception/',
    '/stacktrace/', 'performance-tracking', 'real-user-monitoring', 'web-vitals', 'audience', 'attribution',
    'behavioral-targeting', 'cohort', 'cohort-analysis', 'data-collection', 'data-sync', 'fingerprint',
    'session-replay', 'third-party-cookie', 'user-analytics', 'user-behavior', 'user-cohort', 'user-segment',
    'comscore', 'fbevents', 'fbq', 'google-analytics', 'osano', 'sailthru',
    'utag.js', '/apmapi/', 'canvas-fingerprint', 'canvas-fp', '/canvas-fp/', 'webgl-fingerprint',
    'webgl-fp', '/webgl-fp/', 'audio-fingerprint', 'audio-fp', 'font-fingerprint', 'font-detect-fp'
  ],

// ==UserScript==
// @name         URL Ultimate Filter V46.26
// @namespace    http://tampermonkey.net/
// @version      46.26
// @date         2026-06-13
// @description  SSOT 前端防護盾牌 V46.26 (2026-06-13) | 1531 rules — 極簡盾牌 UI，獨立計數器，點擊外部自動收合。
...
const SCRIPT_VERSION = '46.26';
const SCRIPT_BUILD = 'V46.26 (2026-06-13) | 1531 rules | 3178 tests';
...
const RULES = {
  ...
  CRITICAL_PATH: {
    ...
    ['www.perplexity.ai', new Set([
        'DROP_RE:^/api/auth/phone-verification/status(?:\\?|$)'
      ])],
